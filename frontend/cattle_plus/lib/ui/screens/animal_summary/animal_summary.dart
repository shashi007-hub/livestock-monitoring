...
class AnimalSummaryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Animal Summary', style: Theme.of(context).textTheme.headlineSmall),
        ),
    ...
    return SafeArea(
      child: Container(
        decoration: BoxDecoration(
          color: _getBackgroundColor(animal.status),
        ),
              ...
              children: [
                ...
                _buildSection(
                  ...
                  Table(
                    ...
                    children: animal.healthEntries.map((entry) {
                      return TableRow(
                        children: [
                          Padding(
