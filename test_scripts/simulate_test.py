...
# WAV_FILE_PATH = "LFC1_noisy.wav"  # Must be mono, 16-bit, 22500Hz
idx = None
# Audio chunking config
CHUNK_SIZE = 1024
# AUDIO_FILES = ["LFC1.wav", "LFC1_noisy.wav", "HFC1.wav","HFC1_noisy.wav"]
AUDIO_FILES = ["bite1.wav"]
